...
This document turns the initial checklist into a practical content plan for the current static website template.

Status: draft for review

Important: The school identity below is a proposed direction so the website can be designed and populated quickly. Replace any placeholder details with the school's official information before launch.
...
- General inquiries email: info@schoolbph.com
- Admissions email: admissions@schoolbph.com
...
- Primary colors:
  - Deep green: represents growth, stability, and Nigerian identity
  - Navy blue: represents excellence and discipline
  - Gold: represents achievement and prestige
- Suggested initials for mark: SB
...
- Safe day and boarding environment
- Emphasis on discipline, character formation, and leadership
...
- Facilities overview
- School achievements
- Student life and discipline culture
...
4. Attend a parent and student interview if shortlisted.
...
- Last school result
- Transfer letter or testimonial for transfer students
...
- Mr. Samuel Eke - ICT Coordinator - B.Sc. Computer Science, PGDE
- Mrs. Ebiere Frank - Head of Sciences - B.Sc. Biology, PGDE
- Mr. Chinedu Okafor - Guidance Counselor - B.Ed. Guidance and Counseling
...
- ICT laboratory
- Library
- Sports and inter-house activities
...
## 6. Content and Media Checklist

Before implementation, gather or confirm the following:

- Official school name and preferred short name
- Correct address and map location
- Active phone numbers
- Official email addresses
- Principal name and approved credentials
- Establishment year
- 6 to 12 authentic campus photos
- Staff portraits
- School logo or approval for a redesign
- Admission process details
- Any awards, exam performance data, or notable achievements

## 7. Template Conversion Notes

These updates should be made across the whole site in the next implementation phase:

- Replace all "Fox University" branding with School B branding
- Change "Courses" to "Admissions" in the navigation
- Add a new "Gallery" item to the navigation
- Replace placeholder emails and foreign phone numbers with Nigerian contact details
- Replace generic lorem ipsum text with school-specific copy
- Update all footer contact information
- Replace any university-specific language with secondary school language
- Reuse `blog-single.html` for detailed news posts

## 8. Recommended Next Phase

After approving this strategy, the next build phase should focus on:

1. Updating site-wide branding, navigation, and contact details
2. Rewriting homepage, about, admissions, staff, blog, and contact content
3. Creating `gallery.html`
4. Preparing a simple logo concept
5. Replacing template images with school-appropriate visuals
