  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth="0.5"
        className="fill-transparent stroke-neutral-700 font-[helvetica] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold dark:stroke-neutral-600"
