...
import { ArrowRight, Play, Cpu, Globe, Zap, Hexagon, BarChart3, Wifi } from "lucide-react";
      ...
      >
        <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col items-center justify-center perspective-container">
          ...
          <div className="relative z-10 w-full max-w-[1600px] px-4 sm:px-6 md:px-12 h-full flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 md:gap-12">
            ...
            >
              <div className={`transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-12 blur-sm'}`}>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-950/30 backdrop-blur-md mb-4 sm:mb-6">
                  ...
                  <span className="text-xs font-mono text-cyan-300 tracking-wider">NEXT_GEN SYSTEMS</span>
                </div>
              </div>
              
              <h1 className={`text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tighter text-white leading-[0.9] mb-4 sm:mb-6 drop-shadow-2xl transition-all duration-1000 ease-out delay-200 ${isLoaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-12 blur-sm'}`}>
                FUTURE
              ...
              <p className={`max-w-md text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 font-light leading-relaxed mb-6 sm:mb-8 transition-all duration-1000 ease-out delay-300 ${isLoaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-12 blur-sm'}`}>
                We engineer digital realities that defy boundaries. Experience the synthesis of design and logic.
              </p>

              <div className={`flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start transition-all duration-1000 ease-out delay-500 ${isLoaded ? 'opacity-100 translate-y-0 blur-0' : 'opacity-0 translate-y-12 blur-sm'}`}>
                ...
                <Button variant="ghost" className="h-12 sm:h-14 px-6 sm:px-8 rounded-none border border-white/10 hover:bg-white/5 text-white font-mono tracking-widest text-sm sm:text-base">
                ...
                <div className="absolute inset-0 bg-gray-900">
                  ...
                  <div className="absolute top-3 sm:top-4 lg:top-6 right-3 sm:right-4 lg:right-6 flex flex-col gap-1 sm:gap-2 items-end text-[9px] sm:text-[10px]">
                     <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-cyan-500">NET_Link: ACTIVE</span>
                     </div>
                     <div className="flex items-center gap-2">
                  ...
                  <div className="absolute bottom-3 sm:bottom-4 lg:bottom-6 left-3 sm:left-4 lg:left-6 flex items-center gap-2 sm:gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-sm font-bold tracking-widest text-white">ONLINE</span>
                      </div>
                  </div>
            ...
            >
              <FeatureItem icon={<Globe />} title="GLOBAL SCALE" desc="Infrastructure that spans across borders." />
              <FeatureItem icon={<Zap />} title="HYPER SPEED" desc="Optimized for millisecond latency." />
              <FeatureItem icon={<Hexagon />} title="AI DRIVEN" desc="Neural networks at the core." />
            </div>
  ...
  return (
    <div className="group text-right">
      <div className="flex items-center justify-end gap-3 mb-2 text-white/80 group-hover:text-cyan-400 transition-colors">
        <span className="text-xs sm:text-sm font-bold font-mono tracking-widest">{title}</span>
