...
import { Code, Brush, Printer, Cpu, Shield, Zap, ArrowRight } from "lucide-react";

const services = [
  {
    id: "01",
    title: "NEURAL DESIGN",
    description: "UI/UX interfaces that adapt to user behavior. We craft aesthetic logic.",
  ...
  },
  {
    ...
    description: "Next.js architecture built for extreme performance and scalability.",
  ...
  },
  {
    ...
    description: "Tangible branding that bridges the gap between digital and reality.",
  ...
  },
  {
    id: "04",
    title: "AI SYNERGY",
    description: "Integrating LLMs and neural networks directly into your business logic.",
  ...
  },
  {
    ...
    description: "Fortified digital perimeters ensuring your data remains sovereign.",
...
export function ServicesSection() {
  ...
  return (
    <section ref={containerRef} className="bg-black relative pt-16 sm:pt-20 pb-32 sm:pb-40">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                  ...
                  <div className={`relative h-auto sm:h-[60vh] lg:h-[500px] w-full rounded-2xl sm:rounded-3xl lg:rounded-[32px] bg-[#050505] border border-white/10 overflow-hidden flex flex-col lg:flex-row ${service.glow}`}>
                     ...
                     <div className="relative z-10 flex-1 p-6 sm:p-8 lg:p-12 flex flex-col justify-between">
                         <div>
                            <div className="flex items-center gap-3 mb-4 sm:mb-6">
                                <div className={`p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 ${service.color}`}>
                                    {service.icon}
                                </div>
                                <span className="font-mono text-xs sm:text-sm text-gray-500 tracking-widest">ID_{service.id}</span>
                            </div>
                         ...
                         <div className="mt-6 sm:mt-8 flex items-center gap-2 text-xs sm:text-sm font-mono text-gray-500 group cursor-pointer hover:text-white transition-colors">
                            <span className="uppercase tracking-widest">Initialise Module</span>
                     ...
                     <div className="relative z-10 flex-1 bg-white/5 border-t sm:border-t lg:border-l border-white/10 p-6 sm:p-8 flex items-center justify-center overflow-hidden">
                         ...
                         {/* Abstract Shape */}
                         <div className={`w-28 h-28 sm:w-40 sm:h-40 lg:w-64 lg:h-64 rounded-full border border-white/10 flex items-center justify-center relative ${service.color}`}>
