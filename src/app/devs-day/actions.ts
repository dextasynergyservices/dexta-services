...
export async function registerForDevDay(
  ...
  if (!result.success) {
    return {
      success: false,
      message: result.error.issues[0]?.message ?? 'Validation failed. Please check your inputs.',
    };
  }
  ...
  try {
    ...
    notifyEmail.sender = { name: 'Dev Day · Dexta', email: 'noreply@dextaservices.com' };
    notifyEmail.to = [{ email: 'hello@dextaservices.com', name: 'Dexta Team' }]; // 👈 change to your receiving email
    ...
    confirmEmail.sender = { name: 'Dev Day · Dexta', email: 'noreply@dextaservices.com' };
          ...
          <div style="max-width:580px;margin:0 auto;padding:40px 24px;">
            <div style="border:1px solid #333;border-radius:12px;padding:32px;background:#1a1a1a;">
              ...
              <p style="color:#a0a0a0;font-size:13px;margin:0 0 4px;">
                ...
                <a href="mailto:hello@dextaservices.com" style="color:#00b2ff;text-decoration:none;">hello@dextaservices.com</a>
              </p>
              <div style="margin-top:28px;padding-top:20px;border-top:1px solid #333;">
    ...
    console.error('[Dev Day Registration] Error:', error);
    return {
      success: false,
