...
export function OfferGroupForm({ initialData, onSubmit, onCancel }: Props) {
  ...
  } = useForm<FormValues, unknown, OfferGroupInput>({
  ...
  return (
    ...
    >
      <div>
        ...
        <Input
          id="group-name"
          placeholder="e.g. Communication Reach"
      ...
      <div>
        ...
        <Textarea
          ...
          rows={3}
          placeholder="Brief description shown under the group heading."
      ...
      <div className="flex items-center gap-3 rounded-lg border border-[#222] bg-[#0d0d0d] px-4 py-3">
        ...
        />
        <Label htmlFor="group-visible" className="text-xs text-[#888]">
          Visible on /offers
        </Label>
      </div>
